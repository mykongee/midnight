...
exports.MidnightProvider = void 0;
const vscode = __webpack_require__(1);
const path = __webpack_require__(3);
const fs = __webpack_require__(4);
const parser_js_1 = __webpack_require__(5);
class MidnightProvider {
    ...
    resolveWebviewView(webviewView, context, token) {
        ...
        this._source = (0, parser_js_1.parse)(fs.readFileSync(path.resolve(__dirname, './examples/App.jsx')));
...
MidnightProvider.viewType = 'midnight.sidebarView';
...
var parserModule = __webpack_require__(6);
...
const XHTMLEntities = __webpack_require__(8);
...
Object.defineProperty(module.exports, "tokTypes", ({
  get: function get_tokTypes() {
    return getJsxTokens(__webpack_require__(9)).tokTypes;
  },
  configurable: true,
  enumerable: true
}));
...
function plugin(options, Parser) {
  const acorn = Parser.acorn || __webpack_require__(9);
...
const vscode = __webpack_require__(1);
const MidnightProvider_1 = __webpack_require__(2);
const fs = __webpack_require__(4);
const path = __webpack_require__(3);
const parser_js_1 = __webpack_require__(5);
function activate(context) {
    console.log('Congratulations, your extension "midnight" is now active!');
    const provider = new MidnightProvider_1.MidnightProvider(context);
    context.subscriptions.push(vscode.window.registerWebviewViewProvider('midnight.sidebarView', provider));
    context.subscriptions.push(vscode.commands.registerCommand('midnight.test', () => {
    ...
    let disposable = vscode.commands.registerCommand('midnight.helloWorld', () => {
        ...
        const tree = (0, parser_js_1.parse)(fs.readFileSync(path.resolve(__dirname, './examples/App.jsx')));
